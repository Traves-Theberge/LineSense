...
func (e *Engine) Suggest(ctx context.Context, shell, line, cwd string) ([]Suggestion, error) {
...
func (e *Engine) Explain(ctx context.Context, shell, line, cwd string) (Explanation, error) {
	// TODO: Build context envelope
