...
### Fixed
- Removed 32-bit ARM build support to resolve integer overflow compilation errors in dependencies.
...
### Fixed
- Fixed installation issue where non-interactive installs (e.g., via curl pipe) would fail when configuration files already existed.

## [0.6.1] - 2025-11-18

### Added
- New `update` command to self-update the CLI to the latest version from GitHub Releases.
